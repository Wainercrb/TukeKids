...
@Component({
  selector: 'app-guest-videos',
  templateUrl: './guest-videos.component.html',
  styleUrls: ['./guest-videos.component.css']
})
export class GuestVideosComponent implements OnInit {
  ...
  //get all videos
  getVideos(): void {
    this.videoService.getVideosGuests().subscribe({
